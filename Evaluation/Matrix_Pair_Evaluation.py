...
def evaluate_abstract_object_pair(abstract_object_1: AbstractObject, abstract_object_2: AbstractObject, eval_features: list[Feature]):
    if len(eval_features) == 0:
        return 0

    score = 0
    for feature in eval_features:
        score += feature.evaluate_objects(abstract_object_1, abstract_object_2)
